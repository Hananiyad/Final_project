...
function AboutUs(){
    ...
    return (
        <Container maxWidth="lg" id="containerRoot">
          <Grid container justify="center" spacing={5}>
            <Grid
              ...
              id='imageContainer'
            >
              <Image width="300%" height="200%" id='imge' />
            </Grid>
            <Grid item lg="false">
              <article id='aboutUsArticle'>
                <Typography variant="h2" id='h2t'>About Us</Typography>
                <Typography>
              ...
              <article id='differentArticle'>
                <Typography variant="h3" id='typ'>
